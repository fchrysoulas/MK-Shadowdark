...
- Redesigned encounter Journal pages as readable GM-only reports with a clear encounter header, primary result card, and responsive supporting-table sections.
