...
export const GROUP_SETTING_ACTIVITY_COLUMNS = "groupSheetActivityColumns";
export const GROUP_ACTIVITY_COLUMNS_DEFAULT = 4;
...
export const GROUP_SETTING_TAB_BACKGROUND_TRAVELING = "groupSheetTabBackgroundTraveling";
export const GROUP_SETTING_TAB_BACKGROUND_CAMPING = "groupSheetTabBackgroundCamping";
export const GROUP_SETTING_TAB_BACKGROUND_INVENTORY = "groupSheetTabBackgroundInventory";
export const GROUP_SETTING_TAB_BACKGROUND_HIRELINGS = "groupSheetTabBackgroundHirelings";
export const GROUP_SETTING_TAB_BACKGROUND_MOUNTS = "groupSheetTabBackgroundMounts";
...
export const GROUP_SHEET_ENABLED_SETTING = "enableGroupActors";
export const GROUP_ENCOUNTERS_ENABLED_SETTING = "groupEncountersEnabled";
