...
- Added a GM Screen Encounter Roll Debug Mode setting; when disabled, encounter Journal pages hide dice and result details, and when enabled they show the full roll output.
